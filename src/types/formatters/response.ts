...
import {
  ...
  GetTransactionByBlockHashAndIndexResponseRpc,
  GetTransactionByBlockNumberAndIndexResponseRpc,
...
import { formatStateTransitions, formatWithdrawalTransitions } from "./state";
...
export function formatGetWithdrawalProofResponse(
  rpcObj: GetWithdrawalProofResponseRpc,
): GetWithdrawalProofResponse {
  return {
    to: rpcObj.to,
...
export function formatGetTransactionCountResponse(
  rpcObj: GetTransactionCountResponseRpc,
): GetTransactionCountResponse {
  return BigInt(rpcObj);
}
...
export function formatEstimateL1DataFeeResponse(
  rpcObj: EstimateL1DataFeeResponseRpc,
): EstimateL1DataFeeResponse {
  return BigInt(rpcObj);
}

export function formatGetBlockTransactionCountByHashResponse(
  rpcObj: GetBlockTransactionCountByHashResponseRpc,
): GetBlockTransactionCountByHashResponse {
  return BigInt(rpcObj);
}

export function formatGetBlockTransactionCountByNumberResponse(
  rpcObj: GetBlockTransactionCountByNumberResponseRpc,
): GetBlockTransactionCountByNumberResponse {
  return BigInt(rpcObj);
}

export function formatGetBlockByHashResponse(
  rpcObj: GetBlockByHashResponseRpc,
): GetBlockByHashResponse {
  return formatL2BlockRef(rpcObj);
}

export function formatGetBlockByNumberResponse(
  rpcObj: GetBlockByNumberResponseRpc,
): GetBlockByNumberResponse {
  return formatL2BlockRef(rpcObj);
}

export function formatGetTransactionByHashResponse(
  rpcObj: GetTransactionByHashResponseRpc,
): GetTransactionByHashResponse {
  return formatL2Transaction(rpcObj);
}

export function formatGetTransactionByBlockHashAndIndexResponse(
  rpcObj: GetTransactionByBlockHashAndIndexResponseRpc,
): GetTransactionByBlockHashAndIndexResponse {
  return formatL2Transaction(rpcObj);
}

export function formatGetTransactionByBlockNumberAndIndexResponse(
  rpcObj: GetTransactionByBlockNumberAndIndexResponseRpc,
): GetTransactionByBlockNumberAndIndexResponse {
  return formatL2Transaction(rpcObj);
}

export function formatGetTransactionReceiptResponse(
  rpcObj: GetTransactionReceiptResponseRpc,
): GetTransactionReceiptResponse {
  return {
